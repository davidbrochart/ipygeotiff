...
# -*- coding: utf-8 -*-
#
# ipygeotiff documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipygeotiff', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipygeotiffdoc'
...
latex_documents = [
    (master_doc, 'ipygeotiff.tex', 'ipygeotiff Documentation',
